...
public final class ChooseFitItemRowBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public static ChooseFitItemRowBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ChooseFitItemRowBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.choose_fit_item_row, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ChooseFitItemRowBinding bind(@NonNull View rootView) {
